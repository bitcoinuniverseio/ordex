...
export function renderApiReference(document) {
  ...
  return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="description" content="The Ordex gateway API, generated from its OpenAPI 3.1 contract."><meta property="og:type" content="article"><meta property="og:site_name" content="Ordex"><meta property="og:title" content="Ordex API reference"><meta property="og:description" content="The Ordex gateway API, generated from its OpenAPI 3.1 contract."><meta property="og:url" content="https://bitcoinuniverseio.github.io/ordex/api-reference.html"><meta property="og:locale" content="en"><meta name="twitter:card" content="summary"><title>Ordex API reference</title><link rel="stylesheet" href="styles.css"></head><body><a class="skip-link" href="#main-content">Skip to main content</a><main class="shell">
  ...
  <header class="page-hero" id="main-content" tabindex="-1"><span class="eyebrow">API reference</span><h1>Every route the gateway serves.</h1><p class="lead">Generated from the OpenAPI 3.1 contract, version ${escape(document.info.version)}. Amounts are atomic integers carried as decimal strings. Reads answer 200, writes answer 201, and every write is rate limited.</p></header>
