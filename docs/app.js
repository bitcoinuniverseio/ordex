...
function decorateNavigation() {
  ...
  controls.innerHTML = '<button class="search-trigger" type="button"><span>Search docs</span><kbd>⌘ K</kbd></button><a class="repo-link" href="https://github.com/bitcoinuniverseio/ordex" target="_blank" rel="noreferrer">GitHub <span aria-hidden="true">↗</span></a>';
